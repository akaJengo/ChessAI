 ...
 * 
 * ChessAI creates and populates the board and pieces for the chess engine it
 * also calls the GUI
 * 
 * MyPanel draws the chess board and pieces as well as gets the use inputs from
 * mouse clicks
 * 
 * @author Aidan Larock
...
public class ChessAI {
    ...
    /**
     * Reset populates the user interface chess board
     */
    private void reset() {
 ...
 *          MyPanel
 * 
 *          MyPanel draws the chess board and pieces as well as gets the use
 *          inputs from mouse clicks uses icons to draw the chess pieces
 * 
 */
class MyPanel extends JPanel {
    ...
    /**
     * xValue gets the square which the user clicked
     * 
     * @param space
    ...
    /**
     * yValue gets the square which the user clicked
     * 
     * @param space
    ...
    /**
     * paintComponent paints the chess board and pieces
     * 
     * xSpot[] : x coordinates of chess board ySpot[] : xy coordinates of chess
     * board image: the image of piece to draw
     */
     ...
     * getPiece
     * 
     * this methods returns the correct image depending on the piece.
     * 
     * @param peice
     */
